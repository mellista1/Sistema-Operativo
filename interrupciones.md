...
Offset: Indica la dirección de memoria donde comienza la rutina 
P: bit Present. Indica si la rutina se encuentra en memoria o no. 
DPL: El nivel de privilegio.
D: El tipo de puerta (16/32 bits)
Seg Selector:  indica el selector de segmento de la GDT
Offset: Indica la dirección de memoria donde comienza la rutina
...
Utilizamos como macro IDT_ENTRY pues es la que define la entrada de la IDT. En particular utilizamos IDT_ENTRY0 para interrupciones de nivel del kernel y, por ootro lado, IDT_ENTRY3 para interrupciones de nivel de usuario.
...
Como prologo vos y epilogo usamos pushad y popad que pushea todos los registros y luego los popea.

Usamos iret ya que eso restaura los eflags y cs.
